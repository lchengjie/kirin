...
/** 获取账户资料 POST /api/users/info */
export async function userAccountProfile(body: API.UserAccountInfo, options?: RequestOptions) {
...
export async function accountProfile(options?: RequestOptions) {
  ...
  return request<API.AccountInfo>(url, {
    method: 'GET',
    ...(options || {}),
  });
}
