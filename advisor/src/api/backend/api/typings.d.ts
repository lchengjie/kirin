declare namespace API {
  ...
  type CfgField = {
    ...
    prop: string,
    foldingCard: string,
    foldingCardAccessGroup: string,
    foldingCardTitle: string,
    gridType: string,
    grid: string,
    tab: string,
    tabTitle: string,
  ...
  type KeyNumberValueObj = { [key:string]: number }
  type KeyStringValueObj = { [key:string]: string }
  ...
  type AccountInfo = {
    ...
    phone?: string;
    client: string;
    languageSpoken?: 'zh' | 'en';
    defaultSalesorg?: string;
